...
export default function BottomTaskbar({
  ...
  return (
    <>
      ...
      >
        {activePanel && (
          <div className="flex max-h-[min(70vh,640px)] flex-col border-t border-slate-300 bg-white shadow-2xl dark:border-slate-600 dark:bg-slate-950">
        ...
        <div
          className={`flex items-center justify-center border-t border-slate-300 bg-white/95 backdrop-blur transition-all duration-200 dark:border-slate-600 dark:bg-slate-900/95 ${
            expanded ? 'h-12' : 'h-2'
          }`}
        >
          <div
